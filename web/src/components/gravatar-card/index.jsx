...
export default function GravatarCard({ gravatarData, hasError, isLoading }) {
  if (hasError) {
    return (
      <div className="gravatar-card__error">Gravatar profile not found!</div>
    );
  }
        ...
        <div className="column">
          ...
          <div className="gravatar-card__meta">
            <div>
              ...
              <p>
                <strong>Last Profile Edit:</strong>{" "}
          ...
          <p className="gravatar-card__description">
            {gravatarData.description}
          </p>
