...
const FaultManagerConfig = ({ server }) => {
  ...
  const getModuleIcon = (module) => {
    if (module.includes('cpumem')) return 'fas fa-microchip';
    if (module.includes('disk')) return 'fas fa-hdd';
    if (module.includes('zfs')) return 'fas fa-database';
    if (module.includes('network')) return 'fas fa-network-wired';
    return 'fas fa-cog';
  };

  const getModuleTypeTag = (module) => {
    if (module.includes('retire')) return 'is-info';
    if (module.includes('detector')) return 'is-warning';
    if (module.includes('response')) return 'is-success';
    return 'is-light';
  };
    ...
    <div>
          ...
          <div className='column'>
            <div className='field'>
              ...
              <div className='control'>
                <div className='tags'>
                  {[...new Set(config.map(m => m.module.split('-').pop()))].map((type, index) => (
      ...
      <div className='box'>
        <h4 className='title is-6 mb-4'>
          <span className='icon-text'>
            <span className='icon'><i className='fas fa-puzzle-piece'></i></span>
              ...
              <tbody>
                {config.map((module, index) => (
                  <tr key={index}>
                    <td>
                      <div className='is-flex is-align-items-center'>
                        <span className='icon has-text-info'>
                          <i className={getModuleIcon(module.module)}></i>
                        </span>
                    ...
                    <td>
                      <span className={`tag ${getModuleTypeTag(module.module)} is-small`}>
                        {module.module.includes('retire') ? 'Retire Agent' :
                         module.module.includes('detector') ? 'Detector' :
                         module.module.includes('response') ? 'Response' : 'Module'}
                      </span>
                    </td>
                  </tr>
                ))}
        ...
        <div className='content is-small'>
          <div className='columns'>
            <div className='column'>
              ...
              <ul>
                <li><strong>cpumem-retire:</strong> CPU and memory fault retirement</li>
                <li><strong>disk-retire:</strong> Storage device fault retirement</li>
                <li><strong>zfs-retire:</strong> ZFS pool and dataset fault management</li>
              </ul>
            </div>
            <div className='column'>
              <p><strong>Module Types:</strong></p>
              <ul>
                <li><strong>Retire Agents:</strong> Handle faulty component retirement</li>
                <li><strong>Detectors:</strong> Identify and diagnose faults</li>
                <li><strong>Response Agents:</strong> Automated fault response actions</li>
              </ul>
            </div>
          </div>
        </div>
