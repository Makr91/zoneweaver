                ...
                <div className='level-right'>
                    <div className='field is-grouped'>
                        ...
                        <div className='control'>
                            ...
                            >
                                <span className='icon'>
                                    <i className={`fas ${sectionsCollapsed.filters ? 'fa-chevron-down' : 'fa-chevron-up'}`}></i>
                                </span>
                            </button>
                        </div>
                    </div>
                                    ...
                                    >
                                        ...
                                        {Object.keys(deviceCategories).map(category => (
                                            <option key={category} value={category}>
                                                {category.charAt(0).toUpperCase() + category.slice(1)} ({deviceCategories[category].total})
                                            </option>
                                        ))}
                                    </select>
                                </div>
