...
const EditRepositoryModal = ({ server, repository, onClose, onSuccess, onError }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const originsToRemove = formData.originsToRemove.filter(url => url.trim());
      ...
      const mirrorsToRemove = formData.mirrorsToRemove.filter(url => url.trim());
                ...
                <table className='table is-fullwidth'>
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <span className='tag is-info is-small'>{repository.type}</span>
                      </td>
                    </tr>
                    <tr>
                      <td><strong>Current Location</strong></td>
                      <td className='is-family-monospace is-size-7'>{repository.location}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
                    ...
                    <div key={index} className='field has-addons mb-3'>
                      <div className='control is-expanded'>
                        <input 
                          ...
                          value={origin}
                          onChange={(e) => handleArrayChange('originsToAdd', index, e.target.value)}
                        />
                      </div>
                    ...
                    <div key={index} className='field has-addons mb-3'>
                      <div className='control is-expanded'>
                        <input 
                          ...
                          value={origin}
                          onChange={(e) => handleArrayChange('originsToRemove', index, e.target.value)}
                        />
                      </div>
                      <div className='control'>
                        <button 
                    ...
                    <div key={index} className='field has-addons mb-3'>
                      <div className='control is-expanded'>
                        <input 
                          ...
                          value={mirror}
                          onChange={(e) => handleArrayChange('mirrorsToAdd', index, e.target.value)}
                        />
                      </div>
                      <div className='control'>
                        <button 
                    ...
                    <div key={index} className='field has-addons mb-3'>
                      <div className='control is-expanded'>
                        <input 
                          ...
                          placeholder='URL to remove'
                          value={mirror}
                          onChange={(e) => handleArrayChange('mirrorsToRemove', index, e.target.value)}
                        />
                      </div>
                      <div className='control'>
                        <button 
