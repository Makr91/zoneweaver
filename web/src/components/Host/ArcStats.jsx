                    ...
                    <tbody>
                      {arcStats.slice(0, 1).map((arc) => {
                        ...
                        const hitRatio =
                          arc.hit_ratio ||
                          (arcHits + arcMisses > 0
                            ? ((arcHits / (arcHits + arcMisses)) * 100).toFixed(
                                1
                              )
                            : 0);
                        ...
                        return (
                          <tr key={`arc-overview-${arc.scan_timestamp}`}>
                            ...
                            <td>
                              <span
                                className={`badge ${getHitRatioClass(hitRatio)}`}
                              >
                        ...
                        {arcStats.slice(0, 1).map((arc) => (
                          ...
                          >
                            ...
                            <tr>
                              ...
                              <td>
                                {formatBytes(
                                  parseFloat(arc.metadata_size) || 0
                                )}
                              </td>
                            </tr>
                            <tr>
                              ...
                              <td>
                                {formatBytes(
                                  parseFloat(arc.arc_meta_used) || 0
                                )}
                              </td>
                            </tr>
                            <tr>
                              ...
                              <td>
                                {formatBytes(
                                  parseFloat(arc.arc_meta_limit) || 0
                                )}
                              </td>
                            </tr>
                          </React.Fragment>
                  ...
                  <div className="col-lg-4">
                    ...
                    <table className="table table-striped table-sm">
                      <tbody>
                        {arcStats.slice(0, 1).map((arc) => (
                          <React.Fragment
                            key={`arc-hits-${arc.scan_timestamp}`}
                          >
                            <tr>
                              <td>
                            ...
                            <tr>
                              ...
                              <td>
                                <span className="badge text-bg-warning">
                                  {(
                                    parseFloat(arc.misses || arc.arc_misses) ||
                                    0
                                  ).toLocaleString()}
                                </span>
                              </td>
                    ...
                    <table className="table table-striped table-sm">
                      ...
                      <tbody>
                        {arcStats.slice(0, 1).map((arc) => {
                          ...
                          const l2HitRatio =
                            l2Hits + l2Misses > 0
                              ? ((l2Hits / (l2Hits + l2Misses)) * 100).toFixed(
                                  1
                                )
                              : 0;
                          ...
                          return (
                            <tr key={`arc-l2-${arc.scan_timestamp}`}>
                              ...
                              <td>
                                <span
                                  className={`badge ${getL2HitRatioClass(l2HitRatio)}`}
                                >
                                  {l2HitRatio}%
                                </span>
                              </td>
