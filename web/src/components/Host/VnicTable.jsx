              ...
              <tr key={vnic.id || vnic.link || index}>
                <td>
                  <div className='is-flex is-align-items-center'>
                    ...
                    <span className='ml-2'>
                      <strong className='is-family-monospace'>{vnic.link}</strong>
                    </span>
                  </div>
                </td>
                <td>
                  <span className='is-family-monospace'>{vnic.over || 'N/A'}</span>
                </td>
                <td>
                  {getStateTag(vnic.state)}
                </td>
                <td>
                ...
                <td>
                  <span className='is-size-7' title={vnic.zone}>
                    {vnic.zone && vnic.zone !== '--' 
                      ? (vnic.zone.length > 20 ? vnic.zone.substring(0, 20) + '...' : vnic.zone)
                      : 'Global'
                    }
                  </span>
                </td>
