...
export const autoMapTopology = ({
  ...
  console.log(
    "🔍 TOPOLOGY: Processing bandwidth data:",
    bandwidthData.length,
    "entries"
  );
  console.log(
    "🔍 TOPOLOGY: Raw bandwidth data sample:",
  ...
  bandwidthData.forEach((usage, index) => {
    ...
    if (usage.link && usage.ipackets !== "IPACKETS") {
      ...
      console.log(
        "🔍 TOPOLOGY: Using pre-calculated bandwidth for",
        usage.link,
        ":",
        bandwidth
      );
  ...
  console.log(
    "🔍 TOPOLOGY: Bandwidth map created with",
    bandwidthMap.size,
    "entries"
  );
  console.log(
    "🔍 TOPOLOGY: Bandwidth map contents:",
