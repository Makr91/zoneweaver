                    ...
                    <tr key={module.module}>
                      <td>
                        <div className="d-flex align-items-center">
                          <i
                            className={`${getModuleIcon(module.module)} text-info`}
                          />
                          <span className="ms-2 font-monospace fw-semibold">
                            {module.module}
                          </span>
                        </div>
                      </td>
                      ...
                      <td>
                        <span
                          className={`badge ${getModuleTypeTag(module.module)}`}
                        >
            ...
            <div className="row g-3">
              <div className="col">
                ...
                <ul>
                  ...
                  <li>
                    <strong>disk-retire:</strong> Storage device fault
                    retirement
                  </li>
                  <li>
