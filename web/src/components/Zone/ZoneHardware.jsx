          ...
          <tbody>
            <tr>
              ...
              <td className="px-3 py-2">
                <span className={`has-text-weight-semibold ${configuration.acpi === 'true' ? 'has-text-success' : 'has-text-danger'}`}>
            ...
            <tr>
              ...
              <td className="px-3 py-2">
                <span className={`has-text-weight-semibold ${configuration.autoboot === 'true' ? 'has-text-success' : 'has-text-danger'}`}>
            ...
            <tr>
              ...
              <td className="px-3 py-2"><span className='has-text-grey is-family-monospace'>{configuration.bootrom}</span></td>
              <td className="px-3 py-2"><strong>UEFI Vars</strong></td>
              <td className="px-3 py-2">
                <span className={`has-text-weight-semibold ${configuration.uefivars === 'on' ? 'has-text-success' : 'has-text-danger'}`}>
            ...
            <tr>
              ...
              <td className="px-3 py-2"><span className='has-text-grey is-family-monospace'>{configuration.hostbridge}</span></td>
              <td className="px-3 py-2"><strong>xHCI</strong></td>
              <td className="px-3 py-2">
                <span className={`has-text-weight-semibold ${configuration.xhci === 'on' ? 'has-text-success' : 'has-text-danger'}`}>
            ...
            <tr>
              ...
              <td className="px-3 py-2"><span className='has-text-grey is-family-monospace'>{configuration.brand}</span></td>
              <td className="px-3 py-2"><strong>RNG</strong></td>
              <td className="px-3 py-2">
                <span className={`has-text-weight-semibold ${configuration.rng === 'on' ? 'has-text-success' : 'has-text-danger'}`}>
            ...
            <tr>
              ...
              <td className="px-3 py-2"><span className='has-text-grey is-family-monospace'>{configuration.type || 'N/A'}</span></td>
            ...
            <tr>
              ...
              <td className="px-3 py-2">
                <span className={`has-text-weight-semibold ${zoneDetails.vnc_session_info ? 'has-text-success' : 'has-text-danger'}`}>
