    ...
    async (server, zoneName) => {
      ...
      try {
        ...
        if (result.success) {
          ...
          try {
            console.log(
              `🔍 VNC AUTO-POLL: Checking for existing VNC session for ${zoneName}`
            );
            ...
            if (
              ...
              console.log(
                `✅ VNC AUTO-POLL: Found existing VNC session for ${zoneName}`
              );
              ...
              console.log(
                `❌ VNC AUTO-POLL: No existing VNC session for ${zoneName}`
              );
          ...
          try {
            ...
            if (zloginResult.success && zloginResult.data) {
              ...
              if (activeZoneSession) {
                console.log(
                  `✅ ZLOGIN AUTO-POLL: Found existing zlogin session for ${zoneName}`
                );
                ...
                console.log(
                  `❌ ZLOGIN AUTO-POLL: No existing zlogin session for ${zoneName}`
                );
              ...
              console.log(
                `❌ ZLOGIN AUTO-POLL: No zlogin sessions found for ${zoneName}`
              );
              zoneData.zlogin_session = null;
              zoneData.active_zlogin_session = false;
            }
