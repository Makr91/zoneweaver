  ...
  return (
    ...
    >
          ...
          <table className='table is-fullwidth'>
            <tbody>
              ...
              <tr>
                ...
                <td className='is-family-monospace is-size-7'>{process.command}</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <div className='notification is-danger'>
        <p><strong>Warning:</strong> This will terminate the process.</p>
        <p className='mt-2'>The process will first receive SIGTERM for graceful shutdown. If it doesn't respond, SIGKILL will be sent to force termination.</p>
      </div>
      ...
      <div className='box'>
        ...
        <div className='field'>
          ...
          <p className='help'>If unchecked, the process will first receive SIGTERM for graceful shutdown.</p>
        </div>
      </div>
    </FormModal>
  );
    ...
    >
      ...
      <div className='box'>
        ...
        <div className='field'>
          ...
          <p className='help'>Choose the appropriate signal based on your intent.</p>
        </div>
      </div>

      {/* Signal Information */}
      <div className='notification is-info'>
        <p><strong>Note:</strong> Different signals have different effects on processes.</p>
        <ul className='mt-2'>
          <li>• <strong>SIGTERM:</strong> Requests graceful termination - processes can handle cleanup</li>
          <li>• <strong>SIGKILL:</strong> Forces immediate termination - cannot be ignored or handled</li>
          <li>• <strong>SIGHUP:</strong> Often used to reload configuration files</li>
          <li>• <strong>SIGSTOP/SIGCONT:</strong> Pause and resume process execution</li>
        </ul>
      </div>
    </FormModal>
  );
  ...
  return (
    ...
    >
      ...
      <div className='notification is-danger mb-4'>
        <p><strong>Warning:</strong> This will affect multiple processes matching the pattern.</p>
      ...
      <div className='box mb-4'>
        ...
        <div className='field'>
          <label className='label'>Command Pattern <span className='has-text-danger'>*</span></label>
          <div className='control'>
            <input 
              className='input'
              type='text'
          ...
          <p className='help'>Enter a command name pattern to match processes. This will match processes whose command contains this text.</p>
        </div>
        ...
        <div className='field'>
          ...
          <p className='help'>Optionally limit the operation to processes in a specific zone.</p>
        </div>
      </div>
              ...
              >
                {signals.map((sig) => (
                  <option key={sig} value={sig}>
                    SIG{sig} {sig === 'TERM' ? '(Graceful)' : sig === 'KILL' ? '(Force)' : ''}
                  </option>
                ))}
              </select>
            </div>
          </div>
          <p className='help'>SIGTERM is recommended for graceful shutdown. SIGKILL for force termination.</p>
        </div>
      </div>
      ...
      <div className='notification is-info'>
        ...
        <ul className='mt-2'>
          <li>• <code>apache</code> - Matches all Apache processes</li>
          <li>• <code>bhyve</code> - Matches all VM processes</li>
          <li>• <code>java</code> - Matches all Java applications</li>
          <li>• <code>python</code> - Matches all Python scripts</li>
        </ul>
      </div>
    </FormModal>
  );
