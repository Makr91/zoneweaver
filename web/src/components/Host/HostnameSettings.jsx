        ...
        <div className='box mb-4'>
          ...
          <div className='table-container'>
            <table className='table is-fullwidth'>
              <tbody>
                <tr>
                  <td><strong>Current Hostname</strong></td>
                  <td className='is-family-monospace'>{hostnameInfo.hostname}</td>
                </tr>
                <tr>
                  <td><strong>Nodename File</strong></td>
                  <td className='is-family-monospace'>{hostnameInfo.nodename_file}</td>
                </tr>
                <tr>
                  <td><strong>System Hostname</strong></td>
                  <td className='is-family-monospace'>{hostnameInfo.system_hostname}</td>
                </tr>
                <tr>
                  <td><strong>Configuration Match</strong></td>
                  <td>
                    <span className={`tag ${hostnameInfo.matches ? 'is-success' : 'is-warning'}`}>
          ...
          {!hostnameInfo.matches && (
            <div className='notification is-warning'>
              <p>
                <strong>Warning:</strong> The system hostname does not match the configuration file. 
                This may indicate a pending hostname change that requires a reboot.
              </p>
            </div>
          )}
        </div>
            ...
            <div className='control'>
              <label className='checkbox'>
                <input
                  ...
                  disabled={changing}
                />
                <span className='ml-2'>Apply immediately (no reboot required)</span>
              </label>
            </div>
            <p className='help'>
              {applyImmediately 
