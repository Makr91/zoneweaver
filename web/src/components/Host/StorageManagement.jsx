        ...
        <ul>
          <li className={activeTab === 'arc' ? 'is-active' : ''}>
            <a onClick={() => setActiveTab('arc')}>
              <span className='icon is-small'><i className='fas fa-memory'></i></span>
              <span>ZFS ARC</span>
            </a>
          </li>
          ...
          <li className='is-disabled'>
            <a>
              <span className='icon is-small'><i className='fas fa-folder-tree'></i></span>
        ...
        {activeTab === 'arc' && (
          <div>
            <div className='mb-4'>
              ...
              <p className='content'>
                Configure ZFS Adaptive Replacement Cache (ARC) settings on <strong>{server.hostname}</strong>. 
                The ARC is ZFS's intelligent caching layer that stores frequently accessed data in system memory 
