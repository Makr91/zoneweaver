            ...
            <div className="mb-5">
              ...
              <div className="columns is-multiline">
                {getSortedChartEntries().map(
                  ([deviceName, deviceData], chartIndex) => {
              ...
              {getSortedChartEntries().length > 0 && (
                <div className="has-text-centered mt-3">
                  <p className="is-size-7 has-text-grey">
                    Showing all {getSortedChartEntries().length} devices with
                    I/O activity. Sorted by: {chartSortBy}.
                  </p>
                </div>
              )}
            </div>
          ...
          {poolIOStats.length > 0 && Object.keys(poolChartData).length > 0 && (
            <div className="mb-5">
              ...
              {Object.keys(poolChartData).length > 0 && (
                <div className="has-text-centered mt-3">
                  <p className="is-size-7 has-text-grey">
                    Showing {Object.keys(poolChartData).length} ZFS pools with
                    I/O activity.
                  </p>
                </div>
              )}
