...
const getServiceTypeLabel = (serviceType) => {
  if (serviceType === "ntp") return "NTP";
  if (serviceType === "chrony") return "Chrony";
...
const getSubmitVariant = (buttonClass) => {
  if (buttonClass.includes("warning")) return "is-warning";
  if (buttonClass.includes("success")) return "is-success";
  if (buttonClass.includes("primary")) return "is-primary";
  return "is-info";
};
      ...
      submitVariant={
        actionDetails.buttonClass.includes("warning")
          ...
          : actionDetails.buttonClass.includes("success")
            ? "is-success"
            : actionDetails.buttonClass.includes("primary")
              ? "is-primary"
              : "is-info"
      }
      loading={loading}
