          ...
          <table className='table is-fullwidth is-striped is-size-7'>
            <tbody>
                <tr>
                  ...
                  <td className="px-3 py-2"><span className='has-text-grey is-family-monospace'>{configuration.diskif || 'N/A'}</span></td>
                </tr>
            </tbody>
          </table>
        </div>
        ...
        <div className='mb-3'>
          ...
          <div className='table-container'>
            <table className='table is-fullwidth is-striped is-size-7'>
              ...
              <tbody>
                <tr>
                  <td className="px-3 py-2"><span className='has-text-grey is-size-7 is-family-monospace'>{configuration.bootdisk.path}</span></td>
                  <td className="px-3 py-2"><span className='has-text-grey is-family-monospace'>{configuration.bootdisk.blocksize}</span></td>
                  <td className="px-3 py-2"><span className='has-text-grey is-family-monospace'>{configuration.bootdisk.sparse}</span></td>
                  <td className="px-3 py-2"><span className='has-text-grey is-family-monospace'>{configuration.bootdisk.size}</span></td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div>
          ...
          <div className='table-container'>
            <table className='table is-fullwidth is-striped is-size-7'>
              ...
              <tbody>
                {(configuration.disk || []).filter(disk => disk !== null && disk !== undefined).map((disk, index) => (
                  <tr key={index}>
