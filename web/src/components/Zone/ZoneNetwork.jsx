          ...
          <table className='table is-fullwidth is-striped is-size-7'>
            <tbody>
              <tr>
                ...
                <td className="px-3 py-2"><span className='has-text-grey is-family-monospace'>{configuration.netif || 'N/A'}</span></td>
              </tr>
              <tr>
                <td className="px-3 py-2"><strong>IP Type</strong></td>
                <td className="px-3 py-2"><span className='has-text-grey is-family-monospace'>{configuration['ip-type'] || 'N/A'}</span></td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <div className='mb-3'>
        ...
        <div className='table-container'>
          <table className='table is-fullwidth is-striped is-size-7'>
            ...
            <tbody>
              {(configuration.net || []).filter(netInterface => netInterface !== null && netInterface !== undefined).map((netInterface, index) => (
                <tr key={index}>
