        ...
        <div className='box mb-4'>
            <div className='level is-mobile mb-3'>
                ...
                <div className='level-right'>
                    ...
                    >
                        <span className='icon'>
                            <i className={`fas ${sectionsCollapsed.pptDevices ? 'fa-chevron-down' : 'fa-chevron-up'}`}></i>
                        </span>
                    </button>
                </div>
            </div>
                        ...
                        <tbody>
                            {pptStatus.ppt_devices.map((device, index) => (
                                <tr key={device.id || index}>
                                    ...
                                    <td><code>{device.ppt_device_path || 'N/A'}</code></td>
                                    <td>
                                        <span className={`tag ${device.assigned_to_zones?.length ? 'is-warning' : 'is-success'
                                            }`}>
