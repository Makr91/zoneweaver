        ...
        <div className='box mb-4'>
            <div className='level is-mobile mb-3'>
                ...
                <div className='level-right'>
                    ...
                    >
                        <span className='icon'>
                            <i className={`fas ${sectionsCollapsed.arcStats ? 'fa-chevron-down' : 'fa-chevron-up'}`}></i>
                        </span>
                    </button>
                </div>
            </div>
                                ...
                                <table className='table is-fullwidth is-striped'>
                                    ...
                                    <tbody>
                                        {arcStats.slice(0, 1).map((arc, index) => {
                                            ...
                                            const hitRatio = arc.hit_ratio || (arcHits + arcMisses > 0 ? ((arcHits / (arcHits + arcMisses)) * 100).toFixed(1) : 0);
                                            const compressionRatio = arc.uncompressed_size && arc.compressed_size ?
                                                (parseFloat(arc.uncompressed_size) / parseFloat(arc.compressed_size)).toFixed(2) : 'N/A';
                                            ...
                                            return (
                                                <tr key={index}>
                                                    ...
                                                    <td>
                                                        <div className='tags'>
                                                            <span className='tag is-grey' title='Minimum ARC Size'>
                                                                {formatBytes(parseFloat(arc.arc_min_size) || 0)}
                                                            </span>
                                                            <span className='tag is-dark' title='Maximum ARC Size'>
                                                                {formatBytes(parseFloat(arc.arc_max_size) || 0)}
                                                            </span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <span className={`tag ${hitRatio > 95 ? 'is-success' :
                                                                hitRatio > 90 ? 'is-info' :
                                                                    hitRatio > 80 ? 'is-warning' : 'is-danger'
                                                            }`}>
                                                            {typeof hitRatio === 'number' ? `${hitRatio}%` : hitRatio}
                                                        </span>
                                                    </td>
                                                    <td>
                                                        <span className={`tag ${parseFloat(arc.data_demand_efficiency) > 95 ? 'is-success' :
                                                                parseFloat(arc.data_demand_efficiency) > 90 ? 'is-info' :
                                                                    parseFloat(arc.data_demand_efficiency) > 80 ? 'is-warning' : 'is-dark'
                                                            }`}>
                                                            {arc.data_demand_efficiency ? `${arc.data_demand_efficiency}%` : 'N/A'}
                                                        </span>
                                                    </td>
                                                    <td>
                                                        <span className={`tag ${parseFloat(arc.data_prefetch_efficiency) > 50 ? 'is-success' :
                                                                parseFloat(arc.data_prefetch_efficiency) > 20 ? 'is-info' :
                                                                    parseFloat(arc.data_prefetch_efficiency) > 5 ? 'is-warning' : 'is-dark'
                                                            }`}>
                                                            {arc.data_prefetch_efficiency ? `${arc.data_prefetch_efficiency}%` : 'N/A'}
                                                        </span>
                                                    </td>
                                                    <td>
                                                        <span className={`tag ${parseFloat(compressionRatio) > 2 ? 'is-success' :
                                                                parseFloat(compressionRatio) > 1.5 ? 'is-info' :
                                                                    parseFloat(compressionRatio) > 1.1 ? 'is-warning' : 'is-dark'
                                        ...
                                        <tbody>
                                            {arcStats.slice(0, 1).map((arc, index) => (
                                                <React.Fragment key={index}>
                                                    <tr>
                                                        <td><strong>MRU Size</strong></td>
                                                        <td>{formatBytes(parseFloat(arc.mru_size) || 0)}</td>
                                                    </tr>
                                                    <tr>
                                                        <td><strong>MFU Size</strong></td>
                                                    ...
                                                    <tr>
                                                        <td><strong>Meta Used</strong></td>
                                                        <td>{formatBytes(parseFloat(arc.arc_meta_used) || 0)}</td>
                                                    </tr>
                                                    <tr>
                                                        <td><strong>Meta Limit</strong></td>
                                        ...
                                        <tbody>
                                            {arcStats.slice(0, 1).map((arc, index) => (
                                                <React.Fragment key={index}>
                                                    ...
                                                    <tr>
                                                        <td><strong>Total Misses</strong></td>
                                                        <td>
                                    ...
                                    <table className='table is-fullwidth is-striped is-narrow'>
                                        <tbody>
                                            {arcStats.slice(0, 1).map((arc, index) => (
                                                <React.Fragment key={index}>
                                                    <tr>
                                                        <td><strong>Demand Data Hits</strong></td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td><strong>Demand Data Misses</strong></td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td><strong>Demand Meta Hits</strong></td>
                                                        <td>
                                                            <span className='tag is-success is-small'>
                                                    ...
                                                    <tr>
                                                        <td><strong>Demand Meta Misses</strong></td>
                                                        <td>
                                                            <span className='tag is-warning is-small'>
                                                    ...
                                                    <tr>
                                                        <td><strong>Prefetch Data Hits</strong></td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td><strong>Prefetch Data Misses</strong></td>
                                                        <td>
                                    ...
                                    <table className='table is-fullwidth is-striped is-narrow'>
                                        ...
                                        <tbody>
                                            {arcStats.slice(0, 1).map((arc, index) => {
                                                ...
                                                const l2HitRatio = l2Hits + l2Misses > 0 ? ((l2Hits / (l2Hits + l2Misses)) * 100).toFixed(1) : 0;
                                                ...
                                                return (
                                                    <tr key={index}>
                                                        ...
                                                        <td>
                                                            <span className={`tag ${l2HitRatio > 80 ? 'is-success' :
                                                                    l2HitRatio > 60 ? 'is-info' :
                                                                        l2HitRatio > 40 ? 'is-warning' : 'is-danger'
                                                                }`}>
                                                                {l2HitRatio}%
                                                            </span>
                                                        </td>
