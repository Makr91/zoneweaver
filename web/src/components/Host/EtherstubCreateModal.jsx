  ...
  return (
    ...
    >
      ...
      <div className="notification is-info mt-4">
        ...
        <p>
          Etherstubs provide a virtual Layer 2 switch that allows VNICs to
          communicate with each other without requiring a physical network
          interface. They are useful for creating isolated virtual networks
          within a system.
        </p>
      </div>
    </FormModal>
