                    ...
                    <div className="field">
                      ...
                      <div className="control">
                        <input
                          ...
                          value={filters.grep}
                          onChange={(e) =>
                            handleFilterChange("grep", e.target.value)
                          }
                        />
                      </div>
                    </div>
                      ...
                      <div className="control">
                        <label className="checkbox">
                          <input
                            ...
                            onChange={(e) =>
                              handleFilterChange("tail", e.target.checked)
                            }
                          />
                    ...
                    <div className="field">
                      ...
                      <div className="control">
                        <button
                          ...
                          disabled={
                            logLoading || selectedLog?.type === "fault-manager"
                          }
                          title={
                            selectedLog?.type === "fault-manager"
                              ? "Streaming not available for Fault Manager logs"
                              : isStreaming
                  ...
                  <div className="level-left">
                    <h4 className="title is-6">
                      <span className="icon-text">
                        ...
                        <span>
                          {selectedLog.displayName || selectedLog.name}
                        </span>
                      </span>
                      {logLoading && (
                        <span className="ml-2">
