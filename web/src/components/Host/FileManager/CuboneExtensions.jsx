 ...
 */
export const useCuboneExtensions = (
  files,
  permissions,
  ...
  useEffect(() => {
    ...
    const extendContextMenu = () => {
      ...
      setTimeout(() => {
        ...
        const menuList = contextMenu.querySelector(
          ".file-context-menu-list ul"
        );
        if (!menuList) {
        ...
        console.log(
          "🔍 CONTEXT: Found selected checkboxes:",
        ...
        const fileName =
          selectedCheckboxes[selectedCheckboxes.length - 1]?.getAttribute(
            "name"
          );
        ...
        if (isArchiveFile(selectedFile) && permissions.archive) {
          ...
          customItems.push({
            ...
            action: () =>
              customActionHandlers.handleExtractArchive(selectedFile),
          });
        }
        ...
        if (permissions.properties) {
          ...
          customItems.push({
            ...
            text: "Properties",
            action: () =>
              customActionHandlers.handleShowProperties(selectedFile),
          });
        }
    ...
    const extendToolbar = () => {
      setTimeout(() => {
        ...
        console.log(
          "🔧 TOOLBAR: Found selected checkboxes:",
          selectedCheckboxes.length
        );
    ...
    const setupObservers = () => {
      ...
      const contextMenuObserver = new MutationObserver((mutations) => {
        mutations.forEach((mutation) => {
          if (
            ...
            console.log(
              "🔍 CONTEXT: Context menu became visible, extending..."
            );
            extendContextMenu();
          }
        });
      ...
      if (filesContainer) {
        ...
        console.log(
          "👀 TOOLBAR: Observing file container for selection changes"
        );
      }
