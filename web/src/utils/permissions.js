...
export const canAccessZoneConsole = (userRole) =>
  hasMinPermission(userRole, "user"); // Users can access console
export const canStartStopZones = (userRole) =>
  hasMinPermission(userRole, "user"); // Users can start/stop zones
export const canRestartZones = (userRole) => hasMinPermission(userRole, "user"); // Users can restart zones
export const canDestroyZones = (userRole) =>
  hasMinPermission(userRole, "admin"); // Only admins can destroy zones
...
export const canControlHosts = (userRole) =>
  hasMinPermission(userRole, "admin"); // Only admins can control hosts
export const canPowerOffHosts = (userRole) =>
  hasMinPermission(userRole, "admin"); // Only admins can power off hosts
export const canRegisterHosts = (userRole) =>
  hasMinPermission(userRole, "admin"); // Only admins can register hosts
...
export const canManageApiKeys = (userRole) =>
  hasMinPermission(userRole, "admin"); // Admins can manage API keys
...
export const canViewDashboard = (userRole) =>
  hasMinPermission(userRole, "user"); // All users can view dashboard
