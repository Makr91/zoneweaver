  ...
  return (
    <div>
        ...
        <div className="box mb-4">
          ...
          <div className="table-container">
            <table className="table is-fullwidth">
              <tbody>
                ...
                <tr>
                  <td>
                    <strong>Default Servers Available</strong>
                  </td>
                  <td>
                    <span
                      className={`tag ${configInfo.suggested_defaults?.servers?.length > 0 ? "is-success" : "is-grey"}`}
                    >
                      {configInfo.suggested_defaults?.servers?.length || 0}{" "}
                      servers
                    </span>
                  </td>
                </tr>
          ...
          {!configInfo.config_exists && (
            <div className="notification is-info">
              <p>
                <strong>Configuration file does not exist.</strong>
                <br />
                You can create a new configuration using the template below or
                by manually entering configuration directives.
              </p>
            </div>
          )}
        </div>
      ...
      <div className="box mb-4">
        ...
        {configInfo?.suggested_defaults?.servers &&
          configInfo.suggested_defaults.servers.length > 0 && (
            <div className="content is-small mt-3">
              <p>
                <strong>Suggested default servers:</strong>{" "}
                {configInfo.suggested_defaults.servers.join(", ")}
              </p>
            </div>
          )}
      </div>
      ...
      <div className="box mb-4">
        ...
        <div className="field">
          ...
          {configContent && !isConfigValid(configContent) && (
            <p className="help is-danger">
              Configuration appears to be invalid. Make sure to include at least
              one server or pool directive.
            </p>
          )}
        </div>
        ...
        <div className="field">
          ...
          <p className="help">
            Recommended: Create a backup copy before making changes to allow
            easy recovery.
          </p>
        </div>
      </div>
        ...
        {hasChanges && (
          <div className="notification is-info is-light mt-3">
            <p>
              ...
              synchronization service after saving to apply the new
              configuration.
            </p>
          </div>
        )}
