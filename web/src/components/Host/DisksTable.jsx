      ...
      <div className="d-flex justify-content-between align-items-center mb-3">
        ...
        <div className="d-flex align-items-center gap-2">
          <button
            ...
            title={
              sectionsCollapsed.disks ? "Expand section" : "Collapse section"
            }
          >
            <i
                ...
                <tbody>
                  {storageDisks.map((disk) => (
                    <tr key={getDiskKey(disk)}>
                      ...
                      <td>
                        <span
                          className={`badge ${getHealthColor(disk.health || disk.status)}`}
                        >
                      ...
                      <td>
                        {disk.temperature ? (
                          <span
                            className={`badge ${getTemperatureTagClass(disk.temperature)}`}
                          >
                            {disk.temperature}°C
                          </span>
                        ) : (
